...
At this point, the amount of code we have used for each approach has been fairly equivalent.  The point about using classes, is that it is now very easy to create an arbitrary number of those objects.
