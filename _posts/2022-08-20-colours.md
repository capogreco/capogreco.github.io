...
There is a list of colours which you can pass into `color ()`, `fill ()`, or `background ()`, as strings.  Some of my favourites are `'turquoise'` and `'hotpink'`.  

<iframe width=400 height=442 src="https://editor.p5js.org/capogreco/full/qLnXZ2PBK"></iframe>

Just be sure to remember to put quotation marks around them, so javascript knows to treat them as a string.  You can find a list of colour keywords [here](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value/color_keywords).
